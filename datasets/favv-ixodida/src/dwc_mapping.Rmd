...
resourceRelationShip %<>% mutate(dwc_resourceID = id)

```

```{r}

resourceRelationShip %<>% mutate(dwc_relatedresourceID = unique_id)

```


```{r}
resourceRelationShip %<>% mutate(dwc_relationshipOfResource = 'is pathogen in')
```
