...
```{r}
write_csv(event, here::here("datasets/favv-mosquitoes2016", "data", "processed", "event.csv"), na = "")
...
```{r}
occurrence %<>% mutate(dwc_occurrenceID = str_c("ITG:FAVV:OCC:",occurrence2016_Tube.ID))
```
## eventID
