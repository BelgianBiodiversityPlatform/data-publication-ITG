...
input_data <- read_csv2(file = here::here("datasets", "memo-occurrences", "data", "raw", "00_MEMO_DATABASE_GBIF.csv"))
```
...
```{r}
input_data %<>% select(-c("phone_contact1","phone_contact2","phone_contact3","email_contact1","email_contact2","email_contact3","poe_street","poe_postalcode","contactname1","contactname2","website","poe_contact_remark"))
```
